  ...
  <div class="container">
   <div class="row">
	...
	<?php if(is_front_page() ) { ?>
		<img class="aligncenter size-medium wp-image-158" src="http://www.prettypragmatic.com/wp-content/uploads/2015/11/PP-logo-transparent-285x300.png" alt="PP logo transparent" width="180">
	<?php } ?>
	...
	<div id="dynamic-padding" style="padding:0 <?php the_field('content_padding'); ?>px">
        	<?php the_content(); ?>
	</div>
