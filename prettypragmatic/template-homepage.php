...
<div class="home-wrap clearfix">
			...
			<?php $services_loop = new WP_Query(array('post_type' => 'services', 'posts_per_page' => -1)); ?>
				<ul>
				    <?php
						...
						?>
					    <li>
					    	<a href="<?php echo esc_url( get_permalink(107) ); ?>#<?php echo $post_slug; ?>"><?php the_post_thumbnail('medium'); ?></a>
					    	<h3><a href="<?php echo esc_url( get_permalink(107) ); ?>#<?php echo $post_slug; ?>"><?php the_title(); ?></a></h3>
						</li>

					<?php endwhile; wp_reset_postdata(); ?>
				</ul>
			<p style="text-align:center;clear:both;display:block;margin:0;"><button><a href="what-we-do/">find out more</a></button></p>
		</div>
	</section>
	...
	<section class="clients white_bg">
		<div class="container">
			<div class="padding">
				<h2>who we work with</h2>
			</div>
			<?php $clients_loop = new WP_Query(array('post_type' => 'clients', 'posts_per_page' => -1)); ?>
				<ul>
	...
	<section class="promo">
		...
		<div class="info">
			<img src="<?php the_field('promo_title'); ?>" class="title" />
			<h4><?php the_field('promo_description'); ?></h4>
			<?php echo do_shortcode( '[goal id="629"]' ); ?>
		</div>

		<img src="<?php the_field('promo_bg_image'); ?>" class="city" />
